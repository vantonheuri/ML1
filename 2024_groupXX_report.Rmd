...
<summary>Click to see the NN Confusion Matrix</summary>

```{r NN Findings, echo=FALSE, warning = FALSE, class.source = "fold-show"}
# Confusion matrix
...
<summary>Click to see the SVM Confusion Matrix</summary>
