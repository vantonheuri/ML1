...
# Calculate the order of cantons based on average rental price and select top ten
...
# Adjust the factor levels of Canton for the top ten cantons
...
plot_top_10 <- ggplot(df_total_top_10, aes(x = Canton, y = Price_Gross)) +
  ...
  labs(title = "Top 10 Cantons: Average Rental Price", x = "Canton", y = "Average Rental Price (CHF)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))

# Define highlighted cantons including Zurich (ZH)
highlight_cantons <- c("ZG", "ZU", "AG", "LU", "ZH")
...
# Adjust the factor levels based on the new order in the highlighted cantons
...
plot_highlighted <- ggplot(highlighted_data, aes(x = Canton, y = Average_Price_Gross)) +
  geom_bar(stat = "identity", fill = "#9C8AE6", color = "black") +
  labs(title = "Average Rental Price", x = "Canton", y = "Average Rental Price (CHF)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))

# Arrange both plots side by side
grid.arrange(plot_top_10, plot_highlighted, ncol = 2)
```
